                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(
                        color: isIntact
                            ? ElenzaTheme.emeraldGreen.withOpacity(0.2)
                            : Colors.redAccent.withOpacity(0.2),
                      ),
                      borderRadius: BorderRadius.circular(24),
                      color: isIntact
                          ? ElenzaTheme.emeraldGreen.withOpacity(0.02)
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: TextStyle(
                            ...
                            fontSize: 16,
                            fontWeight: FontWeight.bold,
                            color: isIntact ? ElenzaTheme.emeraldGreen : Colors.redAccent,
                          ),
                        ),
          ...
          Row(
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: isOk
                      ? ElenzaTheme.emeraldGreen.withOpacity(0.1)
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    fontSize: 8,
                    fontWeight: FontWeight.bold,
                    color: isOk ? ElenzaTheme.emeraldGreen : Colors.redAccent,
                  ),
                ),
              ),
            ],
