        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, AUTH_CHANNEL).setMethodCallHandler { call, result ->
            when (call.method) {
                ...
                "registerWithEmail" -> {
                    ...
                    val userMap = mapOf(
                        "uid" to "mock_uid_flutter_" + System.currentTimeMillis(),
                        "email" to email,
                        "sid" to "mock_sid_flutter"
                    )
                ...
                "isLoggedIn" -> {
                    val userMap = mapOf(
                        "uid" to "mock_uid_flutter_session",
                        "email" to "dev@elenza.coffee",
                        "sid" to "mock_sid_flutter"
                    )
                    result.success(userMap)
                }
